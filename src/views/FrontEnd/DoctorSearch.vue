              ...
              <div class="dashboard-widget">
                <div class="card-body">
                  ...
                  <div class="filter-widget mb-3">
                    ...
                    <div
                      v-for="speciality in getSpecialities.data"
                      :key="speciality.id">
                      <label class="custom_check">
                        <input
                          v-model="params.search_array"
              ...
              <div class="doctor-widget">
                <div class="doc-info-left">
                  ...
                  <div class="doc-info-cont">
                    ...
                    <h5 class="doc-department">
                      <img
                        :src="doctor.specialty?.photo"
                        class="img-fluid"
                        alt="Speciality" />{{ doctor.specialty?.name }}
                    </h5>
                ...
                <div class="doc-info-right">
                  ...
                  <div class="clinic-booking">
                    <a class="view-pro-btn mb-2" href="doctor-profile.html"
                      >View Profile</a
                    >
