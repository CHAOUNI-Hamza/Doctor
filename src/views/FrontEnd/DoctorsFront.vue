                            ...
                            <div class="widget-profile">
                                <div class="profile-info-widget text-center">
                                    <a href="" class="doc-img">
                                        <img src="https://www.shutterstock.com/image-photo/profile-picture-smiling-young-caucasian-260nw-1954278664.jpg" alt="user-img">
                                    </a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tabs: [ 'Dashboard', 'Appointments', 'MyPatients', 'ScheduleTimings', 'AvailableTimings',
         'Invoices', 'Accounts', 'Reviews', 'Message', 'SocialeMedia', 'ChangePassword', 'Logout']
      }
    }
  }
  </script>
