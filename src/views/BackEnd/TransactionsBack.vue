                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr v-for="item in 10" :key="item">
                        <td>183</td>
                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#transaction"><span
                              class="text-primary user-name">INV 0007</span></a>
                        </td>
                        <td>
                          <div class="media">
                        ...
                        <td>$330.00</td>
                        <td><span class="badge bg-badge-grey text-success"><i class="fas fa-circle me-1"></i> Paid</span>
                        </td>
                        <td>
