    ...
    <div class="col-md-12">
            ...
            <div id="pricing_select">
              <div class="custom-control form-check custom-control-inline">
                <input
                  ...
                  value="price_free"
                  checked="" />
                <label class="form-check-label ml-2" for="price_free"
                  >Free</label
                >
              </div>
              <div class="custom-control form-check custom-control-inline">
                <input
                  ...
                  value="custom_price"
                  class="form-check-input" />
                <label class="form-check-label ml-2" for="price_custom"
          ...
          <div class="form-group mb-0">
            ...
            <div class="bootstrap-tagsinput">
              <span class="tag badge badge-info"
                >Children Care<span data-role="remove"></span
              ></span>
              <span class="tag badge badge-info"
                >dfdsfsd<span data-role="remove"></span
              ></span>
              <input type="text" placeholder="Enter Specialization" size="20" />
            </div>
            <input
              class="input-tags form-control"
              type="text"
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="add-more">
            <a href="javascript:void(0);" class="add-award"
              ><i class="fa fa-plus-circle"></i> Add More</a
            >
          </div>
        </div>
