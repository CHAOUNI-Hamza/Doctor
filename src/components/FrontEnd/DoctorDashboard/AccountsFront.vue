...
<script>
import Accounts from "./AccountsAccountFront.vue";
import Patients_Refund_Request from "./PatientsRefundFront.vue";
export default {
  components: {
    Accounts,
    Patients_Refund_Request,
  },
  data() {
    return {
      currentTab: "Accounts",
      tabs: ["Accounts", "Patients_Refund_Request"],
    };
  },
};
</script>
