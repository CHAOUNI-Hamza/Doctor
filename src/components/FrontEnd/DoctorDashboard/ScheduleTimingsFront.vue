...
export default {
  ...
  data() {
    return {
      inputs: [
        { value1: "input 1 value1", value2: "input 1 value2" },
        { value1: "input 2 value1", value2: "input 2 value2" },
        { value1: "input 3 value1", value2: "input 3 value2" },
      ],
      currentTab: "Sunday",
      tabs: [
        "Sunday",
