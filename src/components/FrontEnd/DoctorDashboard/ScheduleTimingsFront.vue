                    ...
                    <div class="tab-content schedule-cont p-3">
                      <div v-if="currentTab == 'Sunday'" class="tab-pane-day">
                        <h4 class="card-title d-flex justify-content-between">
                          ...
                          <a type="button" data-toggle="modal" data-target="#addSlot" class="edit-link" data-bs-toggle="modal" href="#add_time_slot">
                            <font-awesome-icon icon="fa-solid fa-circle-plus" /> Add Slot
                          </a>
                        </h4>
                      ...
                      <div class="doc-times d-flex">
                        <div v-for="slot in slots" :key="slot.id" class="doc-slot-list">8:00 pm - 11:30 pm
      ...
      <div class="modal-body">
        <form>
                ...
                <div class="row form-row">
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      ...
                      <select v-model="endtime" class="form-select form-control">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      ...
                      <select v-model="starttime" class="form-select form-control">
                        <option value="fdgdf">30 mins</option>
                        <option value="fdgdf">12.00 am</option>
                        <option value="fdgdf">12.30 am</option>
                        <option value="fdgdf">1.00 am</option>
          ...
          <div class="add-more mb-3">
            <a href="#;" class="add-hours">
              <font-awesome-icon icon="fa-solid fa-circle-plus" /> Add More
            </a>
            </div>
            <div class="submit-section text-center">
              <button @click="addslots()" type="button" class="btn btn-primary submit-btn">Save Changes</button>
            </div>
          </form>
        </div>
    </div>
